...
<div class="news-card">
  ...
  <div class="news-body"><strong>Paper published</strong> &mdash; Our work on remote PPG biometric authentication appears in <em>IEEE Transactions on Computers</em>.</div>
</div>

<div class="news-card">
  <div class="news-date">Nov 2024</div>
  <div class="news-body"><strong>论文接收</strong> &mdash; 我们的论文<em>基于文本自动化分类的隐私政策合规技术研究</em>被<em>信息安全学报</em>接收。</div>
</div>
